...
function computeDepth (x){
    ...
    //Loop starting at 1
    //Add all digits into array
    //Stop loop when new array's length == 10
    
    let digits = []
    for(let i=1; digits.length<=10; i++){
  ...
  //Return: 
  //Int: number of multiples of x it takes to see every digit(0123456789) at least once
  
  //Example
  console.log(computeDepth(3)) //10
  //3691258470