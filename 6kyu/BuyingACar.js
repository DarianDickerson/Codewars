...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
    ...
    while(priceOld + savings < priceNew){
      ...
      priceOld *= 1 - (percentLossByMonth / 100) - ( .005 * Math.ceil(count/2))
      priceNew *= 1 - (percentLossByMonth / 100) - ( .005 * Math.ceil(count/2))
      count++
    }
    
    return [count, Math.round(priceOld + savings - priceNew)]
}