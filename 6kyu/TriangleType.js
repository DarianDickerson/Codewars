...
function triangleType(a, b, c){
    ...
    //A = arccos((b**2 + c**2 - a**2)/ 2 * a * c)
    let degA = Math.acos((b**2 + c**2 - a**2)/ (2 * b * c)) * 180/Math.PI
    let degB = Math.acos((a**2 + c**2 - b**2)/ (2 * a * c)) * 180/Math.PI
    let degC = Math.acos((b**2 + a**2 - c**2)/ (2 * a * b)) * 180/Math.PI
