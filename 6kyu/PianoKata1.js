...
function blackOrWhiteKey(keyPressCount) {
    let keyboard = "wbwwbwbwwbwbwbwwbwbwwbwbwbwwbwbwwbwbwbwwbwbwwbwbwbwwbwbwwbwbwbwwbwbwwbwbwbwwbwbwwbwbwbww"
    let key = keyPressCount > 88 ? (keyPressCount % 88) -1 : keyPressCount-1
    return keyboard[key] === "w" ? "white" : "black"
}