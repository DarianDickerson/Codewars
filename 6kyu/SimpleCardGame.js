...
function winner(deckSteve, deckJosh) {
    const score = ['2','3','4','5','6','7','8','9','T','J','Q','K','A']
    let steve = 0, josh = 0
    
    for(let i=0; i<deckSteve.length; i++){
      if(score.indexOf(deckSteve[i]) > score.indexOf(deckJosh[i])) steve++
      else if(score.indexOf(deckSteve[i]) < score.indexOf(deckJosh[i])) josh++
    }
